...
const PRESCRIBABLE = [STORES.plans, STORES.workouts, STORES.measureTypes, STORES.measurements, STORES.measureGoals, STORES.nutritionGoals, STORES.appointments]
...
const DASHBOARD_STORES = [
  ...
  STORES.measurements, STORES.measureTypes, STORES.measureGoals, STORES.appointments,
]
